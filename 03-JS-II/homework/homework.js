...
function fizzBuzz(numero) {
  ...
  var sal = '';
  if ((numero % 3) === 0 ) sal = 'fizz';
  if ((numero % 5) === 0 ) sal = sal + 'buzz';
  if ( sal === '' ) return (numero)
    else return(sal);
}
...
//  console.log('EsPrimo(' + numero + '): ' + Math.ceil(Math.sqrt(numero)));
  switch(numero) {
    case 0:
    case 1: return(false);
    case 2:
  ...
  let mimax = Math.ceil(Math.sqrt(numero))+1
